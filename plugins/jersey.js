...
const need = "Command കഴിഞ്ഞ് എന്തെങ്കിലും എഴുത് മോനെ\nðŸ—¡ðŸ—¡"
...
if (Config.WORKTYPE == 'private') {
  ...
  Asena.addCommand({ pattern: 'cr7 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
    ...
    var ttinullimage = await axios.get(`https://api.lolhuman.xyz/api/ephoto2/juventusshirt?apikey=beta&text1=MEL-BOT made_by VICHU&text2=7`, { responseType: 'arraybuffer' })
